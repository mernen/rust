...
fn write_vuint(w: io::writer, n: u64) {
    if n < 0x7f_u64 { write_sized_vuint(w, n, 1u); ret; }
    if n < 0x4000_u64 { write_sized_vuint(w, n, 2u); ret; }
    if n < 0x200000_u64 { write_sized_vuint(w, n, 3u); ret; }
    if n < 0x10000000_u64 { write_sized_vuint(w, n, 4u); ret; }
